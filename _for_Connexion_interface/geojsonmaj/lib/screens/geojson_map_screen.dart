...
class GeoJsonMapScreen extends StatefulWidget {
  ...
  const GeoJsonMapScreen({Key? key, required this.user}) : super(key: key);
...
// affichange de la boite de dialogue d'edition
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('SenMapEditor - ${widget.user.zone}'),
          actions: [
            ...
            if (_isSelectionMode) ...[
              IconButton(
                // si le mode de selection est active, alors les boutons actions seront affichés
                icon: const Icon(
